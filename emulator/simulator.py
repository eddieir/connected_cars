...
# create the Flask application for simulating the behaviour of CAR
app = Flask(__name__)
...
if __name__ == '__main__':
    ...
    print('In order to access to the UI at browser, use localhost:' + str(flask_port))
    # The IP address that is used as 0.0.0.0 in order to publicaly accessible
